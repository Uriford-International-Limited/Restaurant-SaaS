...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-primary to-secondary text-gray-100">
      <div className="max-w-7xl px-6 py-7 md:py-14 mx-auto">
        <div className="grid gap-9 md:gap-12 md:grid-cols-4 sm:grid-cols-2">
          {/* Brand / About Section */}
          <div>
        ...
        {/* Bottom Bar */}
        <div className="mt-7 md:mt-14 border-t border-gray-700 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-pink-100/80">
            © {new Date().getFullYear()} Uriford International Ltd. All rights
            reserved.
          </p>
