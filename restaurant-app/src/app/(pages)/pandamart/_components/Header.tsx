...
const Header = () => {
  return (
    <header className="px-2.5 md:px-20 pt-3.5 pb-7 md:pt-4 md:pb-10 bg-primary flex justify-between items-center">
        ...
        <button className="py-0.5 md:py-1 px-2 md:px-4 md:hover:scale-[1.01] bg-accent text-black font-medium rounded-lg cursor-pointer transition-all border">Shop information</button>
    </header>
  )
}
